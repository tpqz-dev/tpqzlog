...
1/ Download mtail here http://ophilipp.free.fr/op_tail.htm and place into the software folder 

2/ How to use : Launch zbrush and load testTpqzLogs.txt
- use the "logs launch log viewer" button to lauch mtail (software used to read the log) 
